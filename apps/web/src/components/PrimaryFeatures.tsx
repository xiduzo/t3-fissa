    ...
    <AppScreen className="w-full">
      ...
      >
        <section style={{color: theme[100]}}>
          <section className='w-full h-8 rounded-md flex items-center px-1 gap-2' style={{backgroundColor: theme[500] +'30'}}>
      ...
      >
        <section className='absolute inset-0 flex items-end z-10' style={{backgroundColor: theme[900] + '70'}}>
          <section className='w-full rounded-t-3xl p-4 md:pb-8 pb-36 bg-gradient-to-br' style={{backgroundColor: theme[500]}}>
            ...
            <article className='flex gap-2 items-center mt-4'>
              <section className='w-12 h-12 border rounded-md flex items-center justify-center' style={{borderColor: theme[900]}}>
  ...
  return (
    <>
      <div
        ...
        className="-mb-4 flex snap-x snap-mandatory -gap-4 overflow-x-auto overscroll-x-contain scroll-smooth pb-4 [scrollbar-width:none] sm:-gap-6 [&::-webkit-scrollbar]:hidden"
      >
        {features.map((feature, featureIndex) => (
          <div
            key={featureIndex}
