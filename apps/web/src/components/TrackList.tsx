...
export function TrackList() {
  ...
  return (
    <section className='gap-4 flex flex-col'>
      <article className='text-white flex justify-between gap-2 items-center p-1.5 -m-1.5 rounded-md'  style={{backgroundColor: theme[100] + '10'}}>
        <section className='flex gap-3 flex-grow'>
          <img className='rounded-md' src="https://i.scdn.co/image/ab67616d00004851273246d060cdf5ddbb6a5ed2" alt="" width={60} height={60} />
      ...
      <article className='text-white flex justify-between gap-2 items-center'>
          <section className='flex gap-3 items-center'>
            <img className='rounded-md' src="https://i.scdn.co/image/ab67616d00004851ba665c3ce15a992b68dbe2f3" alt="" width={60} height={60} />
            <section>
      ...
      <article className='text-white flex justify-between gap-2 items-center'>
          <section className='flex gap-3 items-center'>
            <img className='rounded-md' src="https://i.scdn.co/image/ab67616d000048511581308227d16ad003f1d3ff" alt="" width={60} height={60} />
            <section>
      ...
      <article className='text-white flex justify-between gap-2 items-center'>
          <section className='flex gap-3 items-center'>
            <img className='rounded-md' src="https://i.scdn.co/image/ab67616d00004851255e131abc1410833be95673" alt="" width={60} height={60} />
            <section>
