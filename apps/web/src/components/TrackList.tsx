...
export function TrackList() {
  ...
  return (
    <section className='gap-4'>
      <article className='text-white flex justify-between gap2 items-center p-1.5 -m-1.5 rounded-md'  style={{backgroundColor: theme[100] + '10'}}>
        <section className='flex gap3 flex-grow'>
